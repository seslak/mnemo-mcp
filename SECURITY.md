...
Memory Pack `.mem` files are ZIP containers and may include memory text, metadata, topics, provenance, redaction metadata, and file fingerprint paths/hashes. Review `.mem` files before sharing them outside a trusted environment.
